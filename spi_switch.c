...
#define DAC0_READADC 0 //versus ADC pin
...
void onSpiInt(){//ISR from SSPRXINTR
...
bool parseCommand (){
    ...
    if (!generate_parity(in_command_buf)){//if the incoming data is messy
        //assert error pin?
...
void dacInit(){//DACs connected to SPI1
    gpio_init(LDAC);
